...
@EntityScan(basePackages={"com.ashish.cactus.school.notice.db.model","com.ashish.cactus.school.notice.admin.db.model"})
@EnableJpaRepositories(basePackages = {"com.ashish.cactus.school.notice.db.repositories","com.ashish.cactus.school.notice.admin.db.repositories"})
...
//        targetDataSources.put("cactusschool_admin", addSchoolDatabase("cactusschool_admin"));
    ...
    public LocalContainerEntityManagerFactoryBean noticeEntityManagerFactory() {
        ...
        em.setPackagesToScan(
          new String[] { "com.ashish.cactus.school.notice.db.model" });
